...
```powershell
Get-FileHash .\learning-loop-server-1.0.2-windows-x86_64.zip -Algorithm SHA256
Get-FileHash .\learning-loop-plugin-1.0.2.zip -Algorithm SHA256
```
...
1. Extract `learning-loop-plugin-1.0.2.zip`.
